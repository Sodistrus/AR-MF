...
async def test_gatekeeper_admission():
...
async def test_shard_consistency():
...
async def test_backpressure_lifo():
...
async def main():
    await test_gatekeeper_admission()
    await test_shard_consistency()
    await test_distributed_broadcast()
    await test_backpressure_lifo()
